...
#define LOGI() LOG(LS_INFO) << "AudioDeviceSDL::"
...
int32_t AudioDeviceSDL::InitRecording() 
{
	...
	if (!rec_is_initialized_) {
		...
		capture_audio_id_ = SDL_OpenAudioDevice(NULL, 1, &desired, &mixer, SDL_AUDIO_ALLOW_ANY_CHANGE);
...
int32_t AudioDeviceSDL::RecordingDelay(uint16_t& delayMS) const {
...
int32_t AudioDeviceSDL::PlayoutBuffer(AudioDeviceModule::BufferType& type,
...
int32_t AudioDeviceSDL::ResetAudioDevice() {
  RTC_NOTREACHED() << "Not implemented";
  return -1;
}
...
int32_t AudioDeviceSDL::SetWaveOutVolume(uint16_t, uint16_t) {
  RTC_NOTREACHED() << "Not implemented";
  return -1;
}

int32_t AudioDeviceSDL::WaveOutVolume(uint16_t&, uint16_t&) const {
  RTC_NOTREACHED() << "Not implemented";
  return -1;
}
...
int32_t AudioDeviceSDL::SpeakerVolumeStepSize(uint16_t& stepSize) const {
  RTC_NOTREACHED() << "Not implemented";
  return -1;
}
...
bool AudioDeviceSDL::PlayoutWarning() const {
  return false;
}

bool AudioDeviceSDL::PlayoutError() const {
  return false;
}

bool AudioDeviceSDL::RecordingWarning() const {
  return false;
}

bool AudioDeviceSDL::RecordingError() const {
  return false;
}
...
int32_t AudioDeviceSDL::MicrophoneBoostIsAvailable(bool& available) {
  available = false;
  return 0;
}

int32_t AudioDeviceSDL::SetMicrophoneBoost(bool enable) {
  RTC_NOTREACHED() << "Not implemented";
  return -1;
}

int32_t AudioDeviceSDL::MicrophoneBoost(bool& enabled) const {
  enabled = false;
  return 0;
}
...
int32_t AudioDeviceSDL::SetAGC(bool enable) {
  if (enable) {
...
int32_t AudioDeviceSDL::MicrophoneVolumeStepSize(uint16_t& stepSize) const {
  RTC_NOTREACHED() << "Not implemented";
  return -1;
}
...
int32_t AudioDeviceSDL::SetPlayoutBuffer(
...
int32_t AudioDeviceSDL::CPULoad(uint16_t&) const {
  RTC_NOTREACHED() << "Not implemented";
  return -1;
}
