...
void tcontrol::control_drag_detect(bool start, int x, int y, const tdrag_direction type)
{
	...
	if (did_control_drag_detect_) {
		require_dirty = did_control_drag_detect_(this, start, type);
	}
...
void tcontrol::set_drag_coordinate(int x, int y)
{
	...
	bool require_dirty = true;
	if (did_drag_coordinate_) {
		require_dirty = did_drag_coordinate_(this, first_drag_coordinate_, last_drag_coordinate_);
	}
