...
public:
	...
	void set_did_control_drag_detect(boost::function<bool (tcontrol*, bool start, const tdrag_direction)> callback)
		{ did_control_drag_detect_ = callback; }

	void set_did_drag_coordinate(boost::function<bool (tcontrol*, const tpoint& first, const tpoint& last)> callback)
		{ did_drag_coordinate_ = callback; }
...
private:
	...
	boost::function<bool (tcontrol*, bool start, const tdrag_direction type)> did_control_drag_detect_;

	boost::function<bool (tcontrol*, const tpoint& first, const tpoint& last)> did_drag_coordinate_;
