...
void tstacked_widget::tgrid3::impl_draw_background(texture& frame_buffer, int x_offset, int y_offset)
{
...
void tstacked_widget::tgrid3::impl_draw_children(texture& frame_buffer, int x_offset, int y_offset)
{
